...
{setTimeout("document.getElementById('form_login').submit();",600);},2);},820);});},650);}});var is_lockscreen=$(".login-page").hasClass('is-lockscreen');if(is_lockscreen)
...
{setTimeout(function()
{neonLogin.setPercentage(100,function()
{setTimeout("document.getElementById('form_login').submit();",600);},2);},820);});},650);}});}
